...
function socketFunc(socket) {
  socket.on('loadMorePostsInClient', (param) => {
    ...
    if(!param.length) {
      alert(`There's nothing to fetch anymore.. :(`);
      return false;
    }
